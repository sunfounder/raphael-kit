...
Este proyecto integra el control deslizante y la pantalla de 7 segmentos del proyecto anterior. Para conocer los puntos específicos, consulta :ref:`show_number` y :ref:`metronome`.
