...
Every 100 milliseconds, this function reads the analog value from MCP3008 channel 0. The ADC returns a normalized floating-point number between 0.0 and 1.0. This value is scaled to the 0–255 range and written to GPIO22 using ``pwmWrite()`` to control the LED brightness. The PWM value is also printed to the console.
