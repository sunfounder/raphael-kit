...
Der ADC gibt eine normalisierte Fließkommazahl zwischen 0,0 und 1,0 zurück.  
Dieser Wert wird in den Bereich 0–255 skaliert und mit ``pwmWrite()`` auf GPIO22 ausgegeben, um die LED-Helligkeit zu steuern.  
Der PWM-Wert wird außerdem auf der Konsole ausgegeben.
