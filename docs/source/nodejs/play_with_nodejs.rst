...
We have installed the pigpio package in the raphael-kit/nodejs directory, you only need to test whether it is available.

Enter the nodejs sample directory of Raphael and enter nodejs:
