...
.. note::
    ...
    実行後に動作しない、またはエラープロンプトが表示される場合「wiringPi.h: ファイルまたはディレクトリがありません」、 :ref:`install_wiringpi_pi5` を参照してください。
...
ここにあるコードは、2.1.7 ポテンショメータのものと同じです。他に質問がある場合は、詳細については :ref:`2.1.7_c_pi5` のコードの説明をご確認ください。
