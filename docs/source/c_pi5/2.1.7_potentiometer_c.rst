...
.. note::
    ...
    Si no funciona después de ejecutar el código, o aparece un mensaje de error: \"wiringPi.h: No such file or directory\", por favor refiérase a :ref:`install_wiringpi_pi5`.
