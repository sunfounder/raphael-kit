...
3.1.7 Überhitzungsmonitor (MCP3008)
====================================
...
.. note::
    ...
    * Wenn der Fehler ``wiringPi.h: No such file or directory`` angezeigt wird, siehe :ref:`install_wiringpi_pi5`.
    * Wenn der Fehler ``Unable to open I2C device: No such file or directory`` angezeigt wird, siehe :ref:`i2c_config`, um I2C zu aktivieren und die Verdrahtung zu überprüfen.
    * Wenn Code und Verdrahtung korrekt sind, aber das LCD dennoch nichts anzeigt, kann das Potentiometer auf der Rückseite gedreht werden, um den Kontrast zu erhöhen.
