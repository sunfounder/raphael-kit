...
.. note::
    ...
    Si cela ne fonctionne pas après l'exécution ou s'il y a une erreur indiquant : \"wiringPi.h: Aucun fichier ou répertoire de ce type\", veuillez vous référer à :ref:`install_wiringpi_pi5`.
