...
.. note::
    ...
    Si cela ne fonctionne pas après exécution, ou s'il y a un message d'erreur : \"wiringPi.h:  No such file or directory", veuillez consulter :ref:`install_wiringpi_pi5`.
**Code**
