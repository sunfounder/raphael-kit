...
.. code-block:: c
        ...
        int main(void) {
            ...
            while (1) {
                ...
                int pwmVal = analogVal * 100 / 1023;  // Normalizzazione a 0–100
...
Definisce il canale SPI come CE0 (chip enable 0), imposta la velocità SPI a 1MHz e assegna GPIO3 al pin del LED.
...
* Controlla prima se il numero di canale è nel range valido (0–7).
...
* ``softPwmCreate()`` imposta un PWM software su GPIO3 con un ciclo di lavoro iniziale pari a 0 e un intervallo 0–100.
...
* Scrive il valore PWM al LED, così la luminosità riflette la posizione del potenziometro.
