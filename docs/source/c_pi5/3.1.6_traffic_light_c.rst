...
cifre verrà utilizzato per visualizzare il conto alla rovescia di ciascuno stato 
del semaforo.
...
delle luci del semaforo. Prima si accenderà il LED rosso per 60s, poi il LED 
verde per 30s, e infine il LED giallo per 5s. Dopodiché, il LED rosso si 
riaccenderà per 60s e la sequenza si ripeterà continuamente.
