...
.. note::
    ...
    Remarquez que la rainure de la puce doit être orientée vers la gauche lors de son placement.
...
* Elle initialise un tableau de 3 octets, où :
  ...
  * `buffer[1] = (8 + channel) << 4` : Construit l’octet de configuration pour le mode simple et sélectionne le canal souhaité.
  * `buffer[2] = 0` : Octet de réception pour le résultat.
