...
.. note::
    ...
    Accendi il SPI prima di iniziare l'esperimento, fai riferimento a :ref:`spi_configuration` per i dettagli. È inoltre necessaria la libreria :ref:`BCM2835`.
...
Il pin CS della matrice LED è collegato al pin 24.

.. nota::

    Quando hai più dispositivi che necessitano di comunicazione SPI, collega semplicemente i pin CS su pin differenti.
...
Verifica se la libreria bcm2835 è stata installata correttamente, in caso contrario, stampa il messaggio "Impossibile inizializzare bcm2835".
