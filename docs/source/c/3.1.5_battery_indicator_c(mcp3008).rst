...
Après l’exécution du programme, connectez un fil de sortie au 3ᵉ broche du MCP3008 et un autre au GND, puis reliez‑les aux deux pôles d’une batterie.  
Vous verrez la LED correspondante de la barre LED s’allumer pour afficher le niveau de charge (plage de mesure : 0–5 V).
...
Cette fonction lit les valeurs analogiques de la puce MCP3008 via SPI.  
...
Cette fonction contrôle un afficheur à 10 LED (bar graph).  
Chaque LED représente 1/10 de la plage de tension.  
Les LED sont allumées en séquence jusqu’au niveau spécifié.
