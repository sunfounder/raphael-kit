...
.. note::
    ...
    Les bibliothèques :ref:`install_luma_led_matrix` et :ref:`install_mfrc522` sont également nécessaires.
...
Pour mieux comprendre le programme, vous devrez peut-être d'abord compléter :ref:`1.1.6_py` , :ref:`2.2.10_py` et :ref:`3.1.4_py`.
