...
.. note::
    ...
    The :ref:`install_luma_led_matrix` and the :ref:`install_mfrc522` libraries are also needed.
...
In order to better understand the program, you may need to complete :ref:`1.1.6_py` , :ref:`2.2.10_py` and :ref:`3.1.4_py` first.
