...
.. note::
    ...
    Attiva SPI prima di iniziare l'esperimento, fai riferimento a :ref:`spi_configuration` per i dettagli.
    
    Sono necessarie anche le librerie :ref:`install_luma_led_matrix` e :ref:`mfrc522_lib`.
...
Per comprendere meglio il programma, potrebbe essere necessario completare prima :ref:`1.1.6_py`, :ref:`2.2.10_py` e :ref:`3.1.4_py`.
