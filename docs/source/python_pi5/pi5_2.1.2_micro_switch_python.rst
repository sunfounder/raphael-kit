...
#. Nel ciclo principale, controlla lo stato del micro interruttore. Se premuto, il LED2 si accende e il LED1 si spegne. Se non premuto, il LED2 si spegne e il LED1 si accende. Il ciclo si ripete ogni 0.5 secondi. Gestisce un KeyboardInterrupt (come Ctrl+C) per permettere una chiusura corretta dello script.
